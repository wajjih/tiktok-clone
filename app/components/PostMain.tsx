...
import PostMainLikes from "./PostMain copy";
...
export default function PostMain({ post }: PostMainCompTypes) {
  useEffect(() => {
    ...
    const postMainElement = document.getElementById(`PostMian-${post.id}`);
      ...
      <div id={`PostMain-${post.id}`} className="flex border-b py-6">
        ...
        <div className="pl-3 w-full px-4">
          <div className="flex items-center justify-between pb-0.5">
            ...
            <button className="border text-[15px] px-[21px] p-0.5 border-[#F02C56] hover:bg-[#ffeef2] font-semibold rounded-md">
              Follow
            </button>
          </div>
